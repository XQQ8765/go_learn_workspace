...
//Referece: https://github.com/XQQ8765/glft/blob/master/sec02/lec09/main.go
package main
...
func getItemCostDb1(itemID int) (c float64) {
	fmt.Println("-------getItemCostDb1: itemID:", itemID)
	c = db1[itemID]
	return
}
